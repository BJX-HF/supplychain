...
window.onload = async function () {
    ...
    getOwnedItemsFromEvent(window.accounts[2], 'TransferPartOwnership').then((parts) => {
    ...
    //Then, get products
    getOwnedItemsFromEvent(window.accounts[2], 'TransferProductOwnership').then((products) => {
